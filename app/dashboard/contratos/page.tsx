...
export default function ContratosPage() {
  ...
  // Added a state to keep track of the editing ID for the handleEdit function
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Construct the payload including IS_SANDBOX and LICENCAS
      const payload = isEditing ? {
        id: currentContrato?.ID_EMPRESA,
      ...
      if (response.ok) {
        ...
        resetForm()
        await carregarContratos() // Await the reload to ensure screen updates
      } else {
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="border-t pt-4">
                <h3 className="text-sm font-semibold mb-3">Credenciais Sankhya</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        id="sankhya_password"
                        type={showPasswords.sankhya_password ? "text" : "password"}
                      ...
                      <Button
                        ...
                        size="sm"
                        className="absolute right-0 top-0 h-full"
                        onClick={() => togglePasswordVisibility("sankhya_password")}
                      >
                        {showPasswords.sankhya_password ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                      </Button>
                    </div>
                  </div>
                </div>
              ...
              <div className="border-t pt-4">
                <h3 className="text-sm font-semibold mb-3">Credenciais Gemini</h3>
                <div className="space-y-2">
              ...
              {/* New section for Sandbox environment configuration */}
              <div className="space-y-2 border-t pt-4">
                <Label htmlFor="isSandbox">Ambiente Sankhya</Label>
                <div className="flex items-center space-x-2">
                  <Switch
                    id="isSandbox"
                    checked={formData.IS_SANDBOX || false} // Ensure it's a boolean
